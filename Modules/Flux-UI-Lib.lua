...
function Flux:Window(text, bottom,mainclr,toclose)
	...
	function Tabs.Tab(tabText, ico)
		...
		function ContainerContent.Button(buttonText, desc, layout, callback)
			...
			buttonTitle.Position = UDim2.new(0.0822437406, 0, 0, 0)
			buttonTitle.Size = UDim2.new(0, 113, 0, 42)
			buttonTitle.Font = Enum.Font.Gotham
			buttonTitle.Text = buttonText
			buttonTitle.TextColor3 = Color3.fromRGB(255, 255, 255)
			buttonTitle.TextSize = 15.000
			buttonTitle.TextTransparency = 0.300
			buttonTitle.TextXAlignment = Enum.TextXAlignment.Left

			Circle.Name = "Circle"
			Circle.Parent = buttonTitle
			Circle.Active = true
			...
			Description.Parent = buttonTitle
		...
		function ContainerContent.Toggle(toggleText, desc, default, layout, callback)
			...
			toggleTitle.Position = UDim2.new(0.0822437406, 0, 0, 0)
			toggleTitle.Size = UDim2.new(0, 113, 0, 42)
			...
			Description.Name = "Description"
			Description.Parent = toggleTitle
			Description.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
			Description.BackgroundTransparency = 1.000
			Description.Position = UDim2.new(-0.200942323, 0, 0.785714269, 0)
			Description.Size = UDim2.new(0, 432, 0, 31)
		...
		function ContainerContent.Slider(sliderText,desc,min,max,start,layout,callback)
			...
			sliderTitle.Position = UDim2.new(0.0822437406, 0, 0, 0)
			sliderTitle.Size = UDim2.new(0, 113, 0, 42)
			sliderTitle.Font = Enum.Font.Gotham
			sliderTitle.Text = sliderText
			sliderTitle.TextColor3 = Color3.fromRGB(255, 255, 255)
			sliderTitle.TextSize = 15.000
			sliderTitle.TextTransparency = 0.300
			sliderTitle.TextXAlignment = Enum.TextXAlignment.Left

			Circle.Name = "Circle"
			Circle.Parent = sliderTitle
			Circle.Active = true
			Circle.AnchorPoint = Vector2.new(0.5, 0.5)
			Circle.BackgroundColor3 = Color3.fromRGB(211, 211, 211)
			Circle.Position = UDim2.new(-0.150690272, 0, 0.503000021, 0)
			...
			Description.Name = "Description"
			Description.Parent = sliderTitle
			Description.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
			Description.BackgroundTransparency = 1.000
		...
		function ContainerContent.Dropdown(dropdownText,list,layout,callback)
			...
			dropdownTitle.Position = UDim2.new(0.0822437406, 0, 0, 0)
			dropdownTitle.Size = UDim2.new(0, 113, 0, 42)
			dropdownTitle.Font = Enum.Font.Gotham
			dropdownTitle.Text = dropdownText
			dropdownTitle.TextColor3 = Color3.fromRGB(255, 255, 255)
			dropdownTitle.TextSize = 15.000
			dropdownTitle.TextTransparency = 0.300
			dropdownTitle.TextXAlignment = Enum.TextXAlignment.Left

			Circle.Name = "Circle"
			Circle.Parent = dropdownTitle
			Circle.Active = true
			Circle.AnchorPoint = Vector2.new(0.5, 0.5)
			Circle.BackgroundColor3 = Color3.fromRGB(211, 211, 211)
			Circle.Position = UDim2.new(-0.150690272, 0, 0.503000021, 0)
		...
		function ContainerContent.Colorpicker(colorpickerText,preset,layout,callback)
			...
			colorpickerTitle.Position = UDim2.new(0.0822437406, 0, 0, 0)
			colorpickerTitle.Size = UDim2.new(0, 113, 0, 42)
			colorpickerTitle.Font = Enum.Font.Gotham
			colorpickerTitle.Text = colorpickerText
			colorpickerTitle.TextColor3 = Color3.fromRGB(255, 255, 255)
			colorpickerTitle.TextSize = 15.000
			colorpickerTitle.TextTransparency = 0.300
			...
			Circle.Name = "Circle"
			Circle.Parent = colorpickerTitle
			Circle.Active = true
			Circle.AnchorPoint = Vector2.new(0.5, 0.5)
			Circle.BackgroundColor3 = Color3.fromRGB(211, 211, 211)
			Circle.Position = UDim2.new(-0.150690272, 0, 0.503000021, 0)
			...
			Toggle.Name = "Toggle"
			Toggle.Parent = colorpickerTitle
			...
			Confirm.Parent = colorpickerTitle
		...
		function ContainerContent.Label(labelText, layout)
			...
			labelTitle.Position = UDim2.new(0.038480062, 0, 0, 0)
			labelTitle.Size = UDim2.new(0, 113, 0, 42)
			labelTitle.Font = Enum.Font.Gotham
			labelTitle.Text = labelText
			labelTitle.TextColor3 = Color3.fromRGB(255, 255, 255)
			labelTitle.TextSize = 15.000
			labelTitle.TextTransparency = 0.300
		...
		function ContainerContent.Textbox(textboxText,desc,disapper,layout,callback)
			...
			textboxTitle.Position = UDim2.new(0.0822437406, 0, 0, 0)
			textboxTitle.Size = UDim2.new(0, 113, 0, 42)
			textboxTitle.Font = Enum.Font.Gotham
			textboxTitle.Text = textboxText
			textboxTitle.TextColor3 = Color3.fromRGB(255, 255, 255)
			textboxTitle.TextSize = 15.000
			textboxTitle.TextTransparency = 0.300
			textboxTitle.TextXAlignment = Enum.TextXAlignment.Left

			Circle.Name = "Circle"
			Circle.Parent = textboxTitle
			Circle.Active = true
			Circle.AnchorPoint = Vector2.new(0.5, 0.5)
			Circle.BackgroundColor3 = Color3.fromRGB(211, 211, 211)
			Circle.Position = UDim2.new(-0.150690272, 0, 0.503000021, 0)
			...
			Description.Name = "Description"
			Description.Parent = textboxTitle
			Description.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
			Description.BackgroundTransparency = 1.000
		...
		function ContainerContent.Bind(bindText,presetbind,layout,callback)
			...
			bindTitle.Position = UDim2.new(0.0822437406, 0, 0, 0)
			bindTitle.Size = UDim2.new(0, 113, 0, 42)
			bindTitle.Font = Enum.Font.Gotham
			bindTitle.Text = bindText
			bindTitle.TextColor3 = Color3.fromRGB(255, 255, 255)
			bindTitle.TextSize = 15.000
			bindTitle.TextTransparency = 0.300
			bindTitle.TextXAlignment = Enum.TextXAlignment.Left

			Circle.Name = "Circle"
			Circle.Parent = bindTitle
			Circle.Active = true
			Circle.AnchorPoint = Vector2.new(0.5, 0.5)
			Circle.BackgroundColor3 = Color3.fromRGB(211, 211, 211)
			Circle.Position = UDim2.new(-0.150690272, 0, 0.503000021, 0)
